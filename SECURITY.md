...
vulnerability reporting is enabled for
[`serve-tools/postgres`](https://github.com/serve-tools/postgres), contact the
maintainer privately through the contact information on
[Jonathan Neal's GitHub profile](https://github.com/jonathantneal) before
...
release and may be replaced promptly when PostgreSQL or the upstream archive
project publishes a relevant security update.
