...
arm64/x64 with glibc or musl, and Windows x64.

Windows arm64, 32-bit targets, FreeBSD, and other Unix systems are not currently
packaged. Unsupported targets fail explicitly instead of downloading a fallback.
...
After the public repository exists, use GitHub Discussions or issues for usage
